...
export default function Sidebar({ subreddits, activeTab, onSwitch, onAdd, stackCounts, countdown, lastRefresh, view, onViewMonitors, onViewHolders, onViewNotifications, onViewSubreddits, onViewAlerts, alertCount, onViewAddUsers, onViewAllEdits, onViewLeaderboard, onLogout }: any) {
    ...
    <div style={{ width:236, borderRight:"1px solid #1A1D2E", display:"flex", flexDirection:"column", height:"100%", flexShrink:0 }}>
      ...
      <div style={{ padding:"8px 12px", borderTop:"1px solid #1A1D2E" }}>
        {[
          ...
          {
            label:"Leaderboard", active:view==="leaderboard", color:"#22C55E", bg:"#071A0A", onClick:onViewLeaderboard, badge: null,
          ...
          {
            label:"Users", active:view==="add-users", color:"#A78BFA", bg:"#13092E", onClick:onViewAddUsers, badge: alertCount > 0 ? alertCount : null,
